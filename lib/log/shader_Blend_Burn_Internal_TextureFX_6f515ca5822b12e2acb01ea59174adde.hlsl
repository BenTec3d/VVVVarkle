...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Burn_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Burn_Internal_TextureFX => c70223bddf792bbab28cfbd0346c14d0
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Burn_Internal_TextureFX_6f515ca5822b12e2acb01ea59174adde.hlsl"
...
@G    Pixel => 413c1d597be196d92206c7a13ee983c3
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 137 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Burn_Internal_TextureFX_6f515ca5822b12e2acb01ea59174adde.hlsl"
...
mad_sat r5.w, r0.w, r4.w, r3.w
mul r0.w, r0.w, r3.w

#line 133
div r0.xyz, r4.xyzx, r0.xyzx
add r0.xyz, -r0.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
movc r0.xyz, r1.xyzx, l(0,0,0,0), r0.xyzx  // r0.x <- <GetOp_id23 return value>.x; r0.y <- <GetOp_id23 return value>.y; r0.z <- <GetOp_id23 return value>.z

#line 129
div r1.xyz, r2.xyzx, r5.wwww
add r0.xyz, r0.xyzx, -r1.xyzx
mad r5.xyz, r0.wwww, r0.xyzx, r1.xyzx  // r5.x <- <blend_id21 return value>.x; r5.y <- <blend_id21 return value>.y; r5.z <- <blend_id21 return value>.z
...
mad o0.xyzw, r5.xyzw, r0.xyzw, r1.xyzw
