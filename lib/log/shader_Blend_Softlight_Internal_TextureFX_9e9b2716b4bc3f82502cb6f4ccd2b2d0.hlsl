...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Softlight_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Softlight_Internal_TextureFX => b1560eca0d493db2d201314d0ed0ec9b
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Softlight_Internal_TextureFX_9e9b2716b4bc3f82502cb6f4ccd2b2d0.hlsl"
...
@G    Pixel => d6492034fe721f7d5376e6a799d36703
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 137 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Softlight_Internal_TextureFX_9e9b2716b4bc3f82502cb6f4ccd2b2d0.hlsl"
...
mad r2.xyz, r3.xyzx, r0.xyzx, r2.xyzx
mul r3.xyz, r1.xyzx, r3.xyzx
mad r2.xyz, -r3.xyzx, r0.xyzx, r2.xyzx  // r2.x <- <GetOp_id23 return value>.x; r2.y <- <GetOp_id23 return value>.y; r2.z <- <GetOp_id23 return value>.z

#line 129
mul r0.xyz, r0.wwww, r0.xyzx
add r2.w, -r1.w, l(1.000000)
mul r0.xyz, r0.xyzx, r2.wwww
mad_sat r3.w, r0.w, r2.w, r1.w
mul r0.w, r0.w, r1.w
mad r0.xyz, r1.xyzx, r1.wwww, r0.xyzx
div r0.xyz, r0.xyzx, r3.wwww
add r2.xyz, -r0.xyzx, r2.xyzx
mad r3.xyz, r0.wwww, r2.xyzx, r0.xyzx  // r3.x <- <blend_id21 return value>.x; r3.y <- <blend_id21 return value>.y; r3.z <- <blend_id21 return value>.z
