...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Glow_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Glow_Internal_TextureFX => 0a543b96cf945827857ecd23ed2f279f
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Glow_Internal_TextureFX_c5ea6ae48ca36f97a5edeae78b6be9bd.hlsl"
...
@G    Pixel => 2a08d11aa0d353b75c6553c71d60193e
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 137 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Glow_Internal_TextureFX_c5ea6ae48ca36f97a5edeae78b6be9bd.hlsl"
...
#line 133
eq r3.xyz, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
movc r0.xyz, r3.xyzx, l(1.000000,1.000000,1.000000,0), r0.xyzx  // r0.x <- <GetOp_id23 return value>.x; r0.y <- <GetOp_id23 return value>.y; r0.z <- <GetOp_id23 return value>.z

#line 129
add r0.xyz, -r1.xyzx, r0.xyzx
mad r4.xyz, r0.wwww, r0.xyzx, r1.xyzx  // r4.x <- <blend_id21 return value>.x; r4.y <- <blend_id21 return value>.y; r4.z <- <blend_id21 return value>.z
...
mad o0.xyzw, r4.xyzw, r0.xyzw, r1.xyzw
