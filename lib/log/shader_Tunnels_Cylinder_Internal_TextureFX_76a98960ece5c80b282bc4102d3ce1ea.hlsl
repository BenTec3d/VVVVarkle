...
***** Compiler Parameters *****
***************************
@P EffectName: Tunnels_Cylinder_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Tunnels_Cylinder_Internal_TextureFX => 5d79bb6f120fcd6340ceefa630d3c481
...
//
#line 167 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Tunnels_Cylinder_Internal_TextureFX_76a98960ece5c80b282bc4102d3ce1ea.hlsl"
...
@G    Pixel => 5876ad5391014c0df4e4514b62707d6d
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//      = 0x3f000000 
//   float Offset_id79;                 // Offset:   92 Size:     4 [unused]
//      = 0x00000000 
...
//
#line 147 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Tunnels_Cylinder_Internal_TextureFX_76a98960ece5c80b282bc4102d3ce1ea.hlsl"
mad r0.xy, v1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)  // r0.x <- p.x; r0.y <- p.y
...
#line 142
mad r1.y, r0.y, l(0.318309), cb0[5].y  // r1.y <- uv.y

#line 140
add r0.y, -cb0[5].z, l(1.000000)
mul r0.x, r0.y, r0.x  // r0.x <- r
...
float3 Tunnel_id22(float2 p)
{
    ...
    float r = sqrt(dot(p, p)) * (1 - Dist_id78);
    uv.x = .5 * time_id76 + .5 / r;
    uv.y = (a / (3.1416)) + Rotate_id77;
    return float3(uv, r);
}
