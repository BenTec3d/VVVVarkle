...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Reflect_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Reflect_Internal_TextureFX => 859b20e127b5db09c2d1414992ffe0cf
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Reflect_Internal_TextureFX_8cda71192d84117d2af6728e1ef82e4a.hlsl"
...
@G    Pixel => d9ca3713c77c89fceb4d578fba4091b6
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 137 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Reflect_Internal_TextureFX_8cda71192d84117d2af6728e1ef82e4a.hlsl"
...
mad_sat r4.w, r0.w, r1.w, r3.w
mul r0.w, r0.w, r3.w
mad r2.xyz, r3.xyzx, r3.wwww, r2.xyzx
div r2.xyz, r2.xyzx, r4.wwww

#line 133
mul r5.xyz, r3.xyzx, r3.xyzx
div r0.xyz, r5.xyzx, r0.xyzx
movc r0.xyz, r1.xyzx, l(1.000000,1.000000,1.000000,0), r0.xyzx  // r0.x <- <GetOp_id23 return value>.x; r0.y <- <GetOp_id23 return value>.y; r0.z <- <GetOp_id23 return value>.z

#line 129
add r0.xyz, -r2.xyzx, r0.xyzx
mad r4.xyz, r0.wwww, r0.xyzx, r2.xyzx  // r4.x <- <blend_id21 return value>.x; r4.y <- <blend_id21 return value>.y; r4.z <- <blend_id21 return value>.z
