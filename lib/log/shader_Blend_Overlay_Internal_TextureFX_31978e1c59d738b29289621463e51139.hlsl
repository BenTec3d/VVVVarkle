...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Overlay_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Overlay_Internal_TextureFX => bf42d638bae2d963c473cd10e196ed8e
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Overlay_Internal_TextureFX_31978e1c59d738b29289621463e51139.hlsl"
...
@G    Pixel => a2ce526f03864616795623042b05f42c
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 137 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Overlay_Internal_TextureFX_31978e1c59d738b29289621463e51139.hlsl"
...
#line 129
mul r4.xyzw, r0.xyzw, r2.xyzw
mul r0.xyz, r0.wwww, r0.xyzx
mad_sat r5.w, r0.w, r3.w, r2.w
...
movc r1.xyz, r4.xyzx, r3.xyzx, r1.xyzx  // r1.x <- <GetOp_id23 return value>.x; r1.y <- <GetOp_id23 return value>.y; r1.z <- <GetOp_id23 return value>.z

#line 129
add r1.xyz, -r0.xyzx, r1.xyzx
mad r5.xyz, r4.wwww, r1.xyzx, r0.xyzx  // r5.x <- <blend_id21 return value>.x; r5.y <- <blend_id21 return value>.y; r5.z <- <blend_id21 return value>.z
...
{
    return (c0 < .5) ? (2 * c0 * c1) : 1 - 2 * (1 - c0) * (1 - c1);
}
