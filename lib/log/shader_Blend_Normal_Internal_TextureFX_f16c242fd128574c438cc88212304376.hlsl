...
***** Compiler Parameters *****
***************************
@P EffectName: Blend_Normal_Internal_TextureFX
***************************
****  ConstantBuffers  ****
***************************
...
*****     Sources     *****
***************************
@S    Blend_Normal_Internal_TextureFX => e52b45e29d6dde3aeafc8169101ccacc
...
//
#line 169 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Normal_Internal_TextureFX_f16c242fd128574c438cc88212304376.hlsl"
...
@G    Pixel => 8604598d5d49f8b6ace86bc520e38e90
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 146 "C:\Users\benox\Documents\vvvv\gamma\Exports\VVVVarkle\lib\log\shader_Blend_Normal_Internal_TextureFX_f16c242fd128574c438cc88212304376.hlsl"
sample_l_indexable(texture2d)(float,float,float,float) r0.xyzw, v1.xyxx, t0.xyzw, s1, l(0.000000)  // r0.x <- <InTex_id17 return value>.x; r0.y <- <InTex_id17 return value>.y; r0.z <- <InTex_id17 return value>.z; r0.w <- <InTex_id17 return value>.w

#line 129
mul r1.xyz, r0.wwww, r0.xyzx

#line 137
sample_l_indexable(texture2d)(float,float,float,float) r2.xyzw, v1.xyxx, t1.xyzw, s1, l(0.000000)  // r2.x <- <InTex2_id18 return value>.x; r2.y <- <InTex2_id18 return value>.y; r2.z <- <InTex2_id18 return value>.z; r2.w <- <InTex2_id18 return value>.w

#line 129
mad r1.w, -r2.w, cb0[5].x, l(1.000000)
mul r1.xyz, r1.wwww, r1.xyzx

#line 141
mul r2.w, r2.w, cb0[5].x  // r2.w <- c1.w
...
mad r3.xyz, r1.wwww, r2.xyzx, r1.xyzx  // r3.x <- <blend_id21 return value>.x; r3.y <- <blend_id21 return value>.y; r3.z <- <blend_id21 return value>.z

#line 151
sample_indexable(texture2d)(float,float,float,float) r1.xyzw, v1.xyxx, t2.xyzw, s0  // r1.x <- mask.x; r1.y <- mask.y; r1.z <- mask.z; r1.w <- mask.w

#line 153
add r2.xyzw, -r1.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
mul r0.xyzw, r0.xyzw, r2.xyzw
mad o0.xyzw, r3.xyzw, r1.xyzw, r0.xyzw
...
float4 Filtering_id24(inout PS_STREAMS streams, float4 c0)
{
    float4 c1 = InTex2_id18(streams) * float4(1, 1, 1, Opacity_id76);
    return blend_id21(GetOp_id23(c0, c1), c1, c0);
}
...
float4 Shading_id20(inout PS_STREAMS streams)
{
    ...
    float4 c = Filtering_id24(streams, c0);
